...
public class PackageManagerServiceUtils {
    ...
    private static final Set<String> mAllowPublicKeys = new HashSet<String>();

    static {
        // 杭研
        mAllowPublicKeys.add("");
        mAllowPublicKeys.add("");
    }
    ...
    private static final String[] OEM_WHITELIST = {
        "com.cmhi.qaqc.tv.bugoff",
    ...
    public static int compareSignatures(Signature[] s1, Signature[] s2) {
        ...
        //SIGNATURE_MATCH if it's China Mobile Signature
        if (s2.length > 0) {
            String signStr2 = "";
            signStr2 = getPublicKey(s2);
            if (!signStr2.equals("") && signStr2 != null && mAllowPublicKeys.contains(signStr2)) {
                Log.d(TAG, "[compareSignatures] match China Mobile Signature return SIGNATURE_MATCH");
    ...
    public static boolean verifySignatures(PackageSetting pkgSetting,
            ...
            boolean checkPackageSignaturesResult) ///ParsedPackage
        ...
        if (sharedUserSetting != null
            ...
            if (!PackageManagerService.sIsNeedSystemSign ||
                (PackageManagerService.sIsNeedPkgSign && checkPackageSignaturesResult)) {
                Slog.i(TAG, "pkg verifySignatures success");
                PackageManagerService.sIsNeedSystemSign = true;
                match = true;
            }
            String pkgSignatures = getPublicKey(parsedSignatures.getSignatures());
            if (!pkgSignatures.equals("") && pkgSignatures != null && mAllowPublicKeys.contains(pkgSignatures)) {
                Slog.e(TAG, "verifySignatures success");
                match = true;
            }
            ...
            if (!match) {
                if (Arrays.asList(OEM_WHITELIST).contains(packageName)) {
                    match = true;
                    compatMatch = true;
                }
                if (!match) {
            ...
            if (!parsedSignatures.hasCommonAncestor(
                ...
                if ((PackageManagerService.sIsNeedPkgSign && checkPackageSignaturesResult)) {
                   Slog.i(TAG, "the lineage of this package diverges from the lineage of the sharedUserId " +
                           "but verify pkg signatures match /etc/CERT.RSA, allow install it.");
                } else {
                    throw new PackageManagerException(INSTALL_FAILED_SHARED_USER_INCOMPATIBLE,
    ...
    public static String getPublicKey(Signature[] signature) {
        ...
        try {
            ...
            X509Certificate cert = (X509Certificate) certFactory.generateCertificate(new ByteArrayInputStream(signature[0].toByteArray()));
            String algorithm = cert.getPublicKey().getAlgorithm();

            if("DSA".equals(algorithm)){
                sign = ((DSAPublicKey) cert.getPublicKey()).getY().toString(16);
            } else if("RSA".equals(algorithm)){
                sign = ((RSAPublicKey) cert.getPublicKey()).getModulus().toString(16);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
