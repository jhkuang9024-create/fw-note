...
class ParsedMainComponentUtils {
    ...
    static <Component extends ParsedMainComponentImpl> ParseResult<Component> parseMainComponent(
        ...
        // for CMCC launcher force directBootAware
        if (component.getName().equals("com.cmcc.jarvis")) {
            component.setDirectBootAware(true);
            pkg.setPartiallyDirectBootAware(true);
        }

        // for CMCC launcher force directBootAware
        if (component.getName().equals("com.droidlogic.inputmethod.remote")) {
            component.setDirectBootAware(true);
            pkg.setPartiallyDirectBootAware(true);
        }
