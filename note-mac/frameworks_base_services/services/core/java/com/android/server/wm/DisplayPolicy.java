...
public class DisplayPolicy {
    ...
    DisplayPolicy(WindowManagerService service, DisplayContent displayContent) {
        ...
        if (!CLIENT_TRANSIENT) {
            SystemGesturesPointerEventListener.Callbacks gesturesPointerEventCallbacks =
                ...
                private static final int GESTURE_SWIPE_FROM_TOP = 0;
                private static final int GESTURE_SWIPE_FROM_BOTTOM = 1;
                private static final int GESTURE_SWIPE_FROM_LEFT = 2;
                private static final int GESTURE_SWIPE_FROM_RIGHT = 3;
                private static final int GESTURE_SWIPE_FLING = 4;
                private static final int GESTURE_TOUCH_DOWN = 5;
                private static final int GESTURE_TOUCH_UP = 6;

                private IStatusBarService getIStatusBarService() {
                ...
                public void onSwipeFromTop() {
                    synchronized (mLock) {
                        ...
                        try {
                            IStatusBarService service = getIStatusBarService();
                            service.handleSystemGestures(GESTURE_SWIPE_FROM_TOP);
                        } catch (Exception e) {
                            Slog.e(TAG, "onSwipeFromTop error", e);
                        }
                    }
                }
                ...
                public void onSwipeFromBottom() {
                    synchronized (mLock) {
                        ...
                        try {
                            IStatusBarService service = getIStatusBarService();
                            service.handleSystemGestures(GESTURE_SWIPE_FROM_BOTTOM);
                        } catch (Exception e) {
                            Slog.e(TAG, "onSwipeFromBottom error", e);
                        }
                    }
                }
                ...
                public void onSwipeFromRight() {
                    ...
                    synchronized (mLock) {
                        ...
                        try {
                            IStatusBarService service = getIStatusBarService();
                            service.handleSystemGestures(GESTURE_SWIPE_FROM_RIGHT);
                        } catch (Exception e) {
                            Slog.e(TAG, "onSwipeFromRight error", e);
                        }
                    }
                ...
                public void onSwipeFromLeft() {
                    ...
                    synchronized (mLock) {
                        ...
                        try {
                            IStatusBarService service = getIStatusBarService();
                            service.handleSystemGestures(GESTURE_SWIPE_FROM_LEFT);
                        } catch (Exception e) {
                            Slog.e(TAG, "onSwipeFromLeft error", e);
                        }
                    }
                    excludedRegion.recycle();
                }
                ...
                public void onFling(int duration) {
                    ...
                    try {
                        IStatusBarService service = getIStatusBarService();
                        service.handleSystemGestures(GESTURE_SWIPE_FLING);
                    } catch (Exception e) {
                          Slog.e(TAG, "onFling error", e);
                    }
                }
                ...
                public void onDown() {
                    ...
                    try {
                        IStatusBarService service = getIStatusBarService();
                        service.handleSystemGestures(GESTURE_TOUCH_DOWN);
                    } catch (Exception e) {
                        Slog.e(TAG, "onDown error", e);
                    }
                }
                ...
                public void onUpOrCancel() {
                    ...
                    try {
                        IStatusBarService service = getIStatusBarService();
                        service.handleSystemGestures(GESTURE_TOUCH_UP);
                    } catch (Exception e) {
                        Slog.e(TAG, "onUpOrCancel error", e);
                    }
                }
    ...
    private boolean isOemCompatApp(int uid) {
