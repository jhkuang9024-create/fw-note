...
public final class NetworkConstants {
    ...
    public static boolean hasIpv4(IPStack stack) {
        return 0 != (stack.ordinal() & IPStack.STACK_IPv4.ordinal());
    }

    public static boolean hasIpv4(int stack) {
        return 0 != (stack & IPStack.STACK_IPv4.ordinal());
    }

    public static boolean hasIpv6(IPStack stack) {
        return 0 != (stack.ordinal() & IPStack.STACK_IPv6.ordinal());
    }

    public static boolean hasIpv6(int stack) {
        return 0 != (stack & IPStack.STACK_IPv6.ordinal());
    }
