...
public class NetworkControllerImpl extends BroadcastReceiver
    ...
    private boolean mLastEthConnected = true;
    @VisibleForTesting
    ...
    private void updateConnectivity() {
        boolean wasEthConnected = mLastEthConnected;
        ...
        boolean isEthConnectedNow = mConnectedTransports.get(NetworkCapabilities.TRANSPORT_ETHERNET);

        if (wasEthConnected && !isEthConnectedNow) {
            Log.d(TAG, "Ethernet Disconnected detected! showing toast.");
            showEthDisconnectedToast();
        }
        mLastEthConnected = isEthConnectedNow;
    }

    private void showEthDisconnectedToast() {
        if (mReceiverHandler != null) {
            mReceiverHandler.post(() -> {
                Toast.makeText(mContext,
            mContext.getString(R.string.ethernet_disconnected_toast),
